...
// 	const [distanceToMove, setDistanceToMove] = useState<number>(0);
...
// 	const notify = () => {
// 		toast(`Swipe or press arrow buttons to check out all ${slideLength} posters!!!`, {
// 			toastId: customId,
// 		});
// 	};
...
// 			<div {...handlers} className='carousel-container bg-black overflow-hidden relative'>
...
// 					<CarouselButton onClickFunc={handleClickPrev} direction='prev' hide={slideCount === 1}>
// 						&#x2190;
// 					</CarouselButton>
